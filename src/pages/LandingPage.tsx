...
export const LandingPage: React.FC = () => {
  ...
  return (
    <div className="flex h-dvh flex-col bg-[#0a428d] text-white p-6 font-sans relative overflow-hidden">
      {/* Background Decor */}
      ...
      <div className="z-10 flex flex-col items-center justify-center h-full w-full max-w-md mx-auto animate-in fade-in slide-in-from-bottom-8 duration-700 gap-6">
        <div className="text-center space-y-2 shrink-0">
          <Logo size="lg" />
          <p className="text-base opacity-80 font-medium max-w-[90%] mx-auto">
            {t('landing_subtitle', 'Your AI-powered fashion coach. Instant feedback, brutal honesty.')}
          </p>
        </div>

        <div className="flex items-center justify-center w-full min-h-0 overflow-hidden px-4">
          <img 
            src="/personas.png" 
            alt="Personas" 
