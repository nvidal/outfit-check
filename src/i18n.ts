...
const resources = {
  en: {
    translation: {
      ...
      "share_error": "Could not share image",
      "share_error_canvas": "Could not generate image. Try again or contact support.",
      "settings": "Settings",
      "logout": "Sign Out",
  ...
  es: {
    translation: {
      ...
      "share_error": "No se pudo compartir la imagen",
      "share_error_canvas": "No se pudo generar la imagen. Intenta de nuevo o contacta soporte.",
      "settings": "Ajustes",
